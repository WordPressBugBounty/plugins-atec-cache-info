...
$atec_group_arr = 
[
	['slug'=>'wpau', 'name'=>'auth-keys','desc'=>__('Randomize the authentication keys and salt in the „wp-config.php“ file.','atec-cache-info'),'pro'=>'„PRO“ only','wp'=>false, 'multi'=>true],
	...
	['slug'=>'wpdp', 'name'=>'deploy','desc'=>__('Install and auto update „atec“ plugins','atec-cache-info'),'pro'=>'„PRO“ only','wp'=>false, 'multi'=>true],
	...
	['slug'=>'wpmi', 'name'=>'migrate','desc'=>__('All-in-one site migration, with multisite support.','atec-cache-info'),'pro'=>'„PRO“ only','wp'=>false, 'multi'=>true],
	...
	['slug'=>'wpsh', 'name'=>'shell','desc'=>__('Connect to a remote server via SSH','atec-cache-info'),'pro'=>'„PRO“ only','wp'=>false, 'multi'=>true],
		['slug'=>'wpsmc', 'name'=>'server-monitor','desc'=>__('Check the global availability of your site.','atec-cache-info'),'pro'=>'„PRO“ only','wp'=>false, 'multi'=>true],
