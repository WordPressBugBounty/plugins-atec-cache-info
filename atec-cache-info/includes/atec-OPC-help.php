...
if (!defined('ABSPATH')) { exit; }
	...
	<div id="opcache_help" class="atec-help">
		...
		<ul>
			...
			<li>opcache.memory_consumption=<b>', esc_html($OPC_recommended['memory']), '</b></li>
			<li>opcache.interned_strings_buffer=<b>', esc_html($OPC_recommended['strings']), '</b></li>
			<li>opcache.max_accelerated_files=<b>', esc_html($OPC_recommended['files']), '</b></li>
