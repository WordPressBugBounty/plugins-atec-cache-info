...
private static function init() 
{
	...
	self::$plugins = [
		...
		self::create_plugin('wpdp', 'deploy', 'Install & auto-update atec plugins', 'PRO', false, true),
		self::create_plugin('wpdv', 'developer', 'Debug toolbox for developers', '', false, true),

		self::create_plugin('wpds', 'dir-scan', 'Scan folders by size and count', 'Deep folder scan', true, true),
		self::create_plugin('wpfd', 'flush-debug', 'Admin bar „debug.log” trash button', '', false, true),
		self::create_plugin('wpdpp', 'duplicate-page-post', 'Duplicate posts/pages easily', '', false, true),
		self::create_plugin('wpht', 'htaccess', 'Optimize .htaccess for speed', '', false, true),
		...
		self::create_plugin('wpmi', 'migrate', 'Full site migration', 'Multisite support (PRO)', false, true),

		self::create_plugin('wpocb', 'oc-benchmark', 'Object Cache Benchmark', '', false, true),
		self::create_plugin('wppp', 'page-performance', 'Measure PageScore & SpeedIndex', 'PRO', false, true),
		self::create_plugin('wppo', 'poly-addon', 'Polylang string overrides', '', false, false),
		self::create_plugin('wppr', 'profiler', 'Plugin/theme performance', 'Page timing & queries', true, true),
		self::create_plugin('wprt', 'runtime', 'Runtime stats in admin bar', '', false, true),
