...
final class INIT {
	...
	static $require_install = [ 'wpc', 'wpca', 'wpcm', 'wpcr', 'wpds', 'wpfm', 'wpm', 'wppp', 'wps', 'wpsh', 'wpwp' ];
	...
	public static function admin_debug($slug): void 
	{
		$arr = self::get_admin_debug();
		...
		self::admin_notice($slug, 'warning', rtrim($notice['message'],'.') . '.'); // show admin notice
	}
