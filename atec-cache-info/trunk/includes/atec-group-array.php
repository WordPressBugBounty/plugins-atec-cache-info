...
[
	...
	['slug'=>'wpdpp', 'name'=>'duplicate-page-post','desc'=>__('Duplicate page or post with one click','atec-cache-info'),'pro'=>'./.','wp'=>false],
	...
	['slug'=>'wpll', 'name'=>'limit-login','desc'=>__('Limit login attempts to prevent brute-force attacks','atec-cache-info'),'pro'=>'Attack statistics','wp'=>false],
		['slug'=>'wpmtm', 'name'=>'maintenance-mode','desc'=>__('Single click, temporary maintenance mode for visitors only','atec-cache-info'),'pro'=>'./.','wp'=>false],
	...
	['slug'=>'wpsr', 'name'=>'search-replace','desc'=>__('Search & Replace strings in all tables','atec-cache-info'),'pro'=>'./.','wp'=>false],
