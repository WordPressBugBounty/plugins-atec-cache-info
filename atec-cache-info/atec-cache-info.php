...
{ 
	...
	{ 
		if (atec_wp_menu(__FILE__,'atec_wpci','Cache Info')!==false)
		{				
	...
	if (in_array($atec_active_slug=atec_get_slug(), ['atec_group','atec_wpci'])) { wp_cache_set('atec_wpci_version','1.7.46'); @require('includes/atec-wpci-install.php'); }
}
?>